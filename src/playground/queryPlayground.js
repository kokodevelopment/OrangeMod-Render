...
const handleCursorPositionChanged = () => {
  ...
  if (drawables.cursor >= 0) {
    ...
    const isGpuTouchingA = renderer.isTouchingColor(
      drawables.cursor,
      colors.patternA,
    );
    const isGpuTouchingB = renderer.isTouchingColor(
      drawables.cursor,
      colors.patternB,
    );
    ...
    const isCpuTouchingA = renderer.isTouchingColor(
      drawables.cursor,
      colors.patternA,
    );
    const isCpuTouchingB = renderer.isTouchingColor(
      drawables.cursor,
      colors.patternB,
    );
